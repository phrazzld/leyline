...
- [ ] **T011 · Feature · P2: rewrite tenet 'modularity.md'**
    - **Context:** PLAN.md > Phase 2: Tenet Rewrites > 1. Rewrite Core Tenets
    - **Action:**
    ...
    - **Done‑when:**
        ...
        2. Front-matter is valid per T004.
    - **Depends‑on:** [T003, T008, T004]
- [ ] **T012 · Feature · P2: rewrite tenet 'testability.md'**
    - **Context:** PLAN.md > Phase 2: Tenet Rewrites > 1. Rewrite Core Tenets
    - **Action:**
    ...
    - **Done‑when:**
        ...
        2. Front-matter is valid per T004.
    - **Depends‑on:** [T003, T008, T004]
- [ ] **T013 · Feature · P2: rewrite tenet 'maintainability.md'**
    - **Context:** PLAN.md > Phase 2: Tenet Rewrites > 1. Rewrite Core Tenets
    - **Action:**
    ...
    - **Done‑when:**
        ...
        2. Front-matter is valid per T004.
    - **Depends‑on:** [T003, T008, T004]
- [ ] **T014 · Feature · P2: rewrite tenet 'explicit-over-implicit.md'**
    - **Context:** PLAN.md > Phase 2: Tenet Rewrites > 1. Rewrite Core Tenets
    - **Action:**
    ...
    - **Done‑when:**
        ...
        2. Front-matter is valid per T004.
    - **Depends‑on:** [T003, T008, T004]
- [ ] **T015 · Feature · P2: rewrite tenet 'automation.md'**
    - **Context:** PLAN.md > Phase 2: Tenet Rewrites > 1. Rewrite Core Tenets
    - **Action:**
...
- [ ] **T016 · Feature · P2: rewrite tenet 'document-decisions.md'**
    ...
    - **Done‑when:**
        ...
        2. Front-matter is valid per T004.
    - **Depends‑on:** [T003, T008, T004]
- [ ] **T017 · Feature · P2: rewrite tenet 'no-secret-suppression.md'**
    - **Context:** PLAN.md > Phase 2: Tenet Rewrites > 1. Rewrite Core Tenets
    - **Action:**
...
- [ ] **T022 · Feature · P2: rewrite binding 'external-configuration.md'**
    ...
    - **Done‑when:**
        ...
        2. Front-matter is valid per T004.
    - **Depends‑on:** [T003, T008, T004]
- [ ] **T023 · Feature · P2: rewrite binding 'hex-domain-purity.md'**
    - **Context:** PLAN.md > Phase 3: Binding Rewrites > 1. Rewrite Language-Agnostic Bindings
    - **Action:**
    ...
    - **Done‑when:**
        ...
        2. Front-matter is valid per T004.
    - **Depends‑on:** [T003, T008, T004]
- [ ] **T024 · Feature · P2: rewrite binding 'immutable-by-default.md'**
    - **Context:** PLAN.md > Phase 3: Binding Rewrites > 1. Rewrite Language-Agnostic Bindings
    - **Action:**
    ...
    - **Done‑when:**
        ...
        2. Front-matter is valid per T004.
    - **Depends‑on:** [T003, T008, T004]
- [ ] **T025 · Feature · P2: rewrite binding 'no-internal-mocking.md'**
    - **Context:** PLAN.md > Phase 3: Binding Rewrites > 1. Rewrite Language-Agnostic Bindings
    - **Action:**
