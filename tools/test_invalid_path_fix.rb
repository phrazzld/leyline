...
def test_valid_paths_still_work
  ...
  output = `ruby tools/validate_front_matter.rb -f spec/fixtures/tenets/valid-tenet.md 2>&1`
  ...
  output = `ruby tools/validate_front_matter.rb -f spec/fixtures/bindings/valid-binding.md 2>&1`
