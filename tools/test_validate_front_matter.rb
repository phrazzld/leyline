...
def create_test_validator
  ...
  test_validator_code = validator_code.gsub(
    ...
    %r{tenet_file = Dir\.glob\("docs/tenets/.*?\.md"\)\.first},
  ...
  FileUtils.chmod(0o755, "#{TEST_DIR}/validate_front_matter_test.rb")
...
def verify_validator_behavior
  ...
  valid_binding_output, = run_validator("-f #{TEST_DIR}/docs/bindings/core/valid-core-binding.md")
  category_binding_output, = run_validator("-f #{TEST_DIR}/docs/bindings/categories/typescript/valid-ts-binding.md")
  ...
  missing_keys_output, = run_validator("-f #{TEST_DIR}/docs/bindings/core/missing-keys.md")
  ...
  FileUtils.chmod(0o755, "#{uniqueness_test_dir}/validator.rb")
